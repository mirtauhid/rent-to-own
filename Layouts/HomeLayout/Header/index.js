                ...
                <div className="grid grid-cols-1 smd:grid-cols-2">
                    ...
                    <div className={'flex justify-center items-center smd:justify-end'}>
                        <ul className="flex items-center">
                            ...
                            <li className={'mx-3 hover:shadow border-primary text-xs xs:text-sm px-4 cursor-pointer py-1 border rounded bg-primary text-white transition-all duration-300 font-semibold'}>Login</li>
                        </ul>
                    </div>
                </div>
            </div>
