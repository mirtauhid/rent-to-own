...
export default class ChatItem extends Component {
  ...
  render() {
    return (
      <div className={`${style["defaultWidth"]} min-w-[350px]`}>
        <div
          style={{ animationDelay: `0.8s` }}
          className={`flex ${this.props?.user === "me" ? "justify-end items-end ml-0 mr-0" : "ml-0 mr-10"} mb-6 mx-5`}
        >
          {this.props?.user != "me" ? (
          ...
          <div className={`w-full`}>
            {this.props.messageImages ? (
              ...
              <div className={` bg-gray-100 flex p-4 mx-4 rounded-t-md ${this.props?.user === "me" ? "rounded-bl-md mr-2 bg-blue-100" : "rounded-br-md ml-2"}`}>
